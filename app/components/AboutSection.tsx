...
import me from "../../public/befunky.png";
    ...
    <div className="grid gird-cols-1 lg:grid-cols-3 gap-4 mt-10">
      <Card className="col-span-1 lg:col-span-2 border-none bg-gray-100 p-8">
        <h1 className="text-4xl lg:text-5xl">
          Passionate Web Developer <br /> who loves to create!
        </h1>
        <p className="mt-4 text-muted-foreground lg:text-lg">
          I am a fullstack web developer with a passion for creating beautiful
          and user-friendly web applications. I have experience in developing
