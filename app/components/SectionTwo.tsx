...
const icons = [canva, figma, chatgpt, github, discord, youtube, chrome, notion];
...
const socialMedia = [
  {
    ...
    icon: twitter,
    name: "X / Twitter",
    username: "jateshparikh",
    link: "https://twitter.com/ParikhJatesh",
  },
  {
    id: 2,
    icon: linkedin,
    name: "Linkedin",
    username: "jateshparikh",
    link: "https://www.linkedin.com/in/jatesh-parikh/",
  },
];
      ...
      <div className="flex flex-col w-full col-span-1 lg:col-span-2 gap-4">
        <Card className="bg-gray-100 border-none">
          <CardHeader>
            ...
            <CardDescription>Checkout the tools I use</CardDescription>
          </CardHeader>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 w-full gap-4">
          {socialMedia.map((item) => (
            <Card
              key={item.id}
              className="p-4 flex flex-col items-center sm:items-start bg-gray-100 border-none w-full"
            >
